...
const benefits = [
  ...
  'Detects narrowing or blockages early',
  'Helps prevent stroke and other complications',
  'Painless and safe',
  'Provides guidance for treatment planning',
  'Quick and accurate results',
];

export default function CarotidsPage() {
      ...
      <Box sx={{ bgcolor: '#0A2F4A', color: '#fff', pt: { xs: 3, md: 4 }, pb: { xs: 6, md: 8 } }}>
        <Box sx={{ maxWidth: 1200, mx: 'auto', px: { xs: 3, md: 6 } }}>
          <Button
            ...
            sx={{ color: '#fff', mb: 3, textTransform: 'none', '&:hover': { bgcolor: alpha('#fff', 0.1) } }}
          >
            Back to Services
          </Button>
          ...
          <Typography sx={{ fontSize: { xs: 16, sm: 18 }, lineHeight: 1.7, color: 'rgba(255, 255, 255, 0.9)', maxWidth: 800 }}>
            Ultrasound evaluation of the carotid arteries to assess blood flow and detect blockages.
          </Typography>
        </Box>
      </Box>
        ...
        <Box sx={{ maxWidth: 1000, mx: 'auto', px: { xs: 3, md: 6 } }}>
          <Box sx={{ mb: 6 }}>
            ...
            <Typography sx={{ fontSize: { xs: 15, sm: 16 }, color: '#7A7A7A', lineHeight: 1.8 }}>
              Carotid ultrasound is a safe, non-invasive test that visualizes the carotid arteries in the neck. It helps detect narrowing or blockages that could increase the risk of stroke. This procedure provides valuable information for preventive care and ongoing vascular health management.
            </Typography>
          </Box>
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '3fr 2fr' }, gap: { xs: 4, md: 6 }, alignItems: 'flex-start' }}>
            ...
            <Box sx={{ position: 'relative', width: '100%', height: { xs: 220, sm: 260, md: 300 }, borderRadius: '20px', overflow: 'hidden', border: '3px solid #0A2F4A' }}>
              <Image src="/carotids.jpg" alt="Carotids" fill style={{ objectFit: 'cover' }} />
            </Box>
          </Box>
          ...
          <Box sx={{ mt: 8, textAlign: 'center' }}>
            <Button
              ...
              sx={{
                ...
                '&:hover': { bgcolor: '#a01731', boxShadow: '0 6px 16px rgba(196, 31, 62, 0.4)' },
              }}
            >
              Partner With Us
            </Button>
