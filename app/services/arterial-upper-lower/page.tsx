...
const benefits = [
  'Detects blockages or narrowing in arteries',
  'Non-invasive and safe',
  'Supports early diagnosis of vascular disease',
  'Guides treatment planning',
  'Painless procedure',
  'Quick and reliable results',
];

export default function ArterialPage() {
      ...
      <Box sx={{ bgcolor: '#0A2F4A', color: '#fff', pt: { xs: 3, md: 4 }, pb: { xs: 6, md: 8 } }}>
        <Box sx={{ maxWidth: 1200, mx: 'auto', px: { xs: 3, md: 6 } }}>
          ...
          <Typography sx={{ fontSize: { xs: 16, sm: 18 }, lineHeight: 1.7, color: 'rgba(255, 255, 255, 0.9)', maxWidth: 800 }}>
            Assessment of arterial blood flow in the arms and legs to detect vascular disease.
          </Typography>
        </Box>
      </Box>
        ...
        <Box sx={{ maxWidth: 1000, mx: 'auto', px: { xs: 3, md: 6 } }}>
          <Box sx={{ mb: 6 }}>
            ...
            <Typography sx={{ fontSize: { xs: 15, sm: 16 }, color: '#7A7A7A', lineHeight: 1.8 }}>
              Arterial ultrasound evaluates blood flow in the upper and lower extremities. By identifying narrowing, blockages, or other abnormalities, this test helps diagnose peripheral artery disease and guides treatment planning to improve circulation and overall vascular health.
            </Typography>
          </Box>
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '3fr 2fr' }, gap: { xs: 4, md: 6 }, alignItems: 'flex-start' }}>
            ...
            <Box sx={{ position: 'relative', width: '100%', height: { xs: 220, sm: 260, md: 300 }, borderRadius: '20px', overflow: 'hidden', border: '3px solid #0A2F4A' }}>
              <Image src="/arterial.jpg" alt="Arterial Upper and Lower" fill style={{ objectFit: 'cover' }} />
            </Box>
          </Box>
