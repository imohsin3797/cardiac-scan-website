...
const benefits = [
  ...
  'Detects cysts, fibroids, or other abnormalities',
  'Supports gynecologic health management',
  'Quick and accurate results',
];

export default function FemalePelvicPage() {
      ...
      <Box sx={{ bgcolor: '#0A2F4A', color: '#fff', pt: { xs: 3, md: 4 }, pb: { xs: 6, md: 8 } }}>
        <Box sx={{ maxWidth: 1200, mx: 'auto', px: { xs: 3, md: 6 } }}>
          ...
          <Typography sx={{ fontSize: { xs: 16, sm: 18 }, lineHeight: 1.7, color: 'rgba(255, 255, 255, 0.9)', maxWidth: 800 }}>
            Ultrasound evaluation of female pelvic organs, including the uterus and ovaries.
          </Typography>
        </Box>
      </Box>
        ...
        <Box sx={{ maxWidth: 1000, mx: 'auto', px: { xs: 3, md: 6 } }}>
          <Box sx={{ mb: 6 }}>
            ...
            <Typography sx={{ fontSize: { xs: 15, sm: 16 }, color: '#7A7A7A', lineHeight: 1.8 }}>
              Transabdominal female pelvic ultrasound provides a non-invasive assessment of the uterus, ovaries, and surrounding structures. It helps detect cysts, fibroids, or other abnormalities and is commonly used for routine evaluations or symptom-based investigations.
            </Typography>
          </Box>
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '3fr 2fr' }, gap: { xs: 4, md: 6 }, alignItems: 'flex-start' }}>
            ...
            <Box sx={{ position: 'relative', width: '100%', height: { xs: 220, sm: 260, md: 300 }, borderRadius: '20px', overflow: 'hidden', border: '3px solid #0A2F4A' }}>
              <Image src="/femalepelvic.jpg" alt="Female Pelvic" fill style={{ objectFit: 'cover' }} />
            </Box>
          </Box>
