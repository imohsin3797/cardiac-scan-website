...
const benefits = [
  ...
  'Quick results for preventive care',
  'Supports proactive treatment planning',
];

export default function AAAScreeningPage() {
      ...
      <Box sx={{ bgcolor: '#0A2F4A', color: '#fff', pt: { xs: 3, md: 4 }, pb: { xs: 6, md: 8 } }}>
        <Box sx={{ maxWidth: 1200, mx: 'auto', px: { xs: 3, md: 6 } }}>
          ...
          <Typography sx={{ fontSize: { xs: 16, sm: 18 }, lineHeight: 1.7, color: 'rgba(255, 255, 255, 0.9)', maxWidth: 800 }}>
            Screening ultrasound to detect enlargement or aneurysms of the abdominal aorta.
          </Typography>
        </Box>
      </Box>
        ...
        <Box sx={{ maxWidth: 1000, mx: 'auto', px: { xs: 3, md: 6 } }}>
          <Box sx={{ mb: 6 }}>
            ...
            <Typography sx={{ fontSize: { xs: 15, sm: 16 }, color: '#7A7A7A', lineHeight: 1.8 }}>
              This screening exam identifies aneurysms in the abdominal aorta before symptoms develop. Early detection allows for monitoring, lifestyle adjustments, or surgical intervention, reducing the risk of rupture and serious complications.
            </Typography>
          </Box>
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '3fr 2fr' }, gap: { xs: 4, md: 6 }, alignItems: 'flex-start' }}>
            ...
            <Box sx={{ position: 'relative', width: '100%', height: { xs: 220, sm: 260, md: 300 }, borderRadius: '20px', overflow: 'hidden', border: '3px solid #0A2F4A' }}>
              <Image src="/abdominalaortascreening.jpg" alt="AAA Screening" fill style={{ objectFit: 'cover' }} />
            </Box>
          </Box>
